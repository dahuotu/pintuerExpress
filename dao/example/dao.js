...
module.exports = {
	...
	deleteByWhere: function (req, res, next) {
		...
		pool.getConnection(function (err, connection) {
			connection.query($sql.deleteByWhere, [param.title], function (err, result) {
				if (result.affectedRows > 0) {
					result = {
						code: 0,
						msg: '删除成功',
	...
	updateByWhere: function (req, res, next) {
		...
		var param = req.query;
		if (param.title == null || param.content == null || param.where == null) {
			result = {
				code: -1,
				msg: '参数错误'
			};
		...
		pool.getConnection(function (err, connection) {
			connection.query($sql.updateByWhere, [param.title, param.content, param.where], function (err, result) {
				if (result.affectedRows > 0) {
					result = {
						code: 0,
						msg: '修改成功',
	...
	queryByWhere: function (req, res, next) {
		...
		pool.getConnection(function (err, connection) {
			connection.query($sql.queryByWhere, [param.title], function (err, result) {
				if (result != null) {
					result = {
						code: 0,
						msg: '查询成功',
	...
	queryPage: function (req, res, next) {
		...
		pool.getConnection(function (err, connection) {
			connection.query($sql.queryPage, [+param.index, +param.size], function (err, result) {
				if (result != null) {
					result = {
						code: 0,
						msg: '查询成功',
